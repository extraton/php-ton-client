...
class TvmTest extends AbstractModuleTest
{
     ...
     * @covers \Extraton\TonClient\Processing::processMessage
     * @covers \Extraton\TonClient\Net::waitForCollection
     * @covers \Extraton\TonClient\Tvm::runTvm
     */
    ...
    public function testRunGet(): void
    {
        ...
        $stateInitSource = StateInitSource::fromStateInit($electorCode, $electorData);

        $resultOfEncodeAccount = $this->abi->encodeAccount($stateInitSource);
        $account = $resultOfEncodeAccount->getAccount();

        $resultOfRunGet = $this->tvm->runGet($account, 'participant_list');
        ...
        self::assertEquals($expected, $resultOfRunGet->getOutput());

        $resultOfRunGet = $this->tvm->runGet(
            $account,
            'compute_returned_stake',
            null,
            explode(':', $electorAddress)[1]
        );

        self::assertEquals('0', $resultOfRunGet->getOutput()[0]);
        ...
        self::assertEquals('1588268660', $resultOfRunGet->getOutput()[0][0][0]);
    ...
    /**
     * @covers ::runExecutor
     * @covers \Extraton\TonClient\Boc::parseAccount
     */
    public function testRunExecutorWithAccountForExecutorNone(): void
    {
        ...
        $account = $resultOfRunExecutor->getAccount();

        $resultOfParse = $this->boc->parseAccount($account);

        self::assertEquals(
            '0:f18d106c11586689b11e946269ec1550b69654a8d5964de668149c28877fb65a',
            $resultOfParse->getParsed()['id']
        );

        self::assertEquals(
            'Uninit',
            $resultOfParse->getParsed()['acc_type_name']
        );
    }
    ...
    public function testRunExecutorWithAccountForExecutorUninit(): void
    {
        ...
        $accountForExecutor = AccountForExecutor::fromUninit();
        ...
        self::assertEquals($resultOfEncodeMessage->getAddress(), $resultOfParse->getParsed()['id']);
        self::assertEquals('Active', $resultOfParse->getParsed()['acc_type_name']);
    }
}